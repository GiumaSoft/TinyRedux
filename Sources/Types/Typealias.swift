...
/// Stream chain step in the pipeline fold: ticks active stream entries post-reducer and removes exhausted ones.
internal typealias StreamChain = @MainActor () -> Void
