...
@frozen public struct MiddlewareContext<S, A>: Sendable where S : ReduxState, A : ReduxAction {
  ...
  /// completes successfully; otherwise reducers may run before the async result is known.
  ...
  public var args: (S.ReadOnly, @MainActor @Sendable (UInt, A...) -> Void, @MainActor @Sendable (A) throws -> Void, A) {
