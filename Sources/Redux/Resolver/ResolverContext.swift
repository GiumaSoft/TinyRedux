...
/// whether the store retries with another action, reduces an action directly, moves to the next
/// resolver, or fails immediately. The context includes a complete hook for timing logs. Use args
/// for quick destructuring when writing small resolver functions. This keeps remediation logic
