...
- [2. Architecture](#2-architecture)
  - [2.1. Dispatch Pipeline](#21-dispatch-pipeline)
  - [2.2. Core Types](#22-core-types)
  - [2.3. Dispatch API](#23-dispatch-api)
  - [2.4. Pipeline Construction](#24-pipeline-construction--builddispatchprocess)
  - [2.5. Context Pattern](#25-context-pattern)
- [3. Abstraction](#3-abstraction)
  ...
  - [3.4. Component Hierarchy](#34-component-hierarchy)
  - [3.5. Logical Flows](#35-logical-flows)
  - [3.6. Features](#36-features)
- [4. Discussing Feature](#4-discussing-feature)
  - [4.1. @MainActor Pipeline](#41-mainactor-pipeline)
  - [4.2. Type-Erasure: Struct Concrete](#42-type-erasure-struct-concrete)
  - [4.3. Worker State Ownership](#43-worker-state-ownership)
  - [4.4. Enum Return Pattern](#44-enum-return-pattern)
  - [4.5. Resolve → Reduce](#45-resolve--reduce)
  - [4.6. Deferred](#46-deferred-async-throws-return-based)
  - [4.7. Pipeline Flows](#47-pipeline-flows)
  - [4.8. Contesti Semplificati](#48-contesti-semplificati)
  - [4.9. Log/Timing Automatico](#49-logtiming-automatico)
...
### 2.4. Pipeline Construction — `buildDispatchProcess()`
...
### 4.6. Deferred (async throws, return-based)
...
# Coding Style:
use coding style rules described at ".claude/docs/CODING_STYLE_RULES.md"