...
extension Sample.SwiftUI {
  struct Sample01View {
    @EnvironmentObject private var store: SubStore<AppState, AppActions, Sample01State, Sample01Actions>
...
extension Sample.SwiftUI.Sample01View: View {
  var body: some View {
    VStack(spacing: 24) {
      _dates_
      _disclaimer_
  ...
  @ViewBuilder private var _dates_: some View {
    List {
      ForEach(store.state, id: \.self) { date in
